...
def write_instructors():
    ...
    instructor_joy = Instructor(first_name = "Joy", last_name = "Chen", dob = date(1962, 7, 16), full_time = True, total_learners = 2002)
    instructor_joy.save()

    instructor_peter = Instructor(first_name = "Peter", last_name = "Li", dob = date(1962, 7, 16), full_time = True, total_learners = 10040)
    instructor_peter.save()
    print("Instructor objects all saved.... ")

def write_courses():
    #Add Courses
    course_cloud_app = Course(name = "cloud Application Development" , description = "Develop and deploy application on cloud")
    course_cloud_app.save()
    course_python = Course(name = "Introduction to Python", description = "Learn core concepts of python and obtain hands-on")
    course_python.save()
